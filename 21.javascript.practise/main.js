  ...
  (allProducts.innerHTML = ""),
    ...
    <div class="card" style="width: 18rem">
      ...
      <div class="card-body">
        ...
        <button class="btn btn-primary btn-add" onclick=addToBasket("${
          element._id
...
function addToBasket(paramid) {
  console.log(paramid);
  let findeID = products.find((item) => item._id == paramid);
  console.log(findeID);

  basketItems.push(findeID);
